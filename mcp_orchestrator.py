...
Также каждый звонок имеет ровно один тег "call", а каждое сообщение почты - тег "mail". Он нужен, если необходимо посчитать количество всех звонков или писем за какой-либо период. 
Если твоего пользователя интересует число писем независимо от их содержания, используй тег "mail" в качестве target_tags и необходимые метрики для их группировки и или подсчета.
